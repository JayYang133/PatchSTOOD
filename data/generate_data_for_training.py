...
def generate_train_val_test(args):
    ...
    for y in years:
        file_path = os.path.join(base_dir, 'data', args.dataset, args.dataset + '_his_' + y + '.h5')
        df_tmp = pd.read_hdf(file_path)
        print(file_path)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--years', type=str, default='2017_2018_2019_2020_2021', help='if use data from multiple years, please use underline to separate them, e.g., 2018_2019')
